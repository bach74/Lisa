...
*/
 ...
 /**
\brief my servo drive
	Note: added by bach
	Fixed joint although technically not a drive, is a way of getting a fixed joint and not a d6 joint
*/
 NX_MY_SERVO_DRIVE	= (1<<2),
 NX_REVOLUTE_DRIVE	= (1<<3),
 NX_NO_MOTOR_DRIVE	= (1<<4),
 NX_FIXED_JOINT	= (1<<5)
};

...
bool instantiateCollection(NxOgre::World* world, NxuPhysicsCollection	*c,	NxPhysicsSDK &sdk, NxScene *scene,const NxMat34 *rootNode,	NXU_userNotify *ur)
{
	bool ret = false;

	if ( c )
	{
  	NxuPhysicsInstantiator Instantiator(c, world);
...
bool instantiateScene(NxOgre::World* world, NxuPhysicsCollection	*c,const char *sceneName,NxPhysicsSDK &sdk, NxScene *scene, NxMat34 *rootNode,	NXU_userNotify *un)
{
	bool ret = false;

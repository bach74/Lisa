...
const char * EnumToString(NxD6JointDriveType v)
{
  ...
  switch ( v )
  {
    ...
    //bach
	case NX_MY_SERVO_DRIVE: ret = "MY_SERVO_DRIVE"; break;
	case NX_REVOLUTE_DRIVE: ret = "REVOLUTE_DRIVE"; break;
	case NX_NO_MOTOR_DRIVE: ret = "NO_MOTOR_DRIVE"; break;
	case NX_FIXED_JOINT: ret = "FIXED_JOINT"; break;
    //endbach
	default: break;
  }
  return ret;
...
bool         StringToEnum(const char *str,NxD6JointDriveType &v)
{
  ...
  //bach
  else if ( _stricmp(str,"MY_SERVO_DRIVE") == 0 ) { v = NX_MY_SERVO_DRIVE; ret = true; }
  else if ( _stricmp(str,"REVOLUTE_DRIVE") == 0 ) { v = NX_REVOLUTE_DRIVE; ret = true; }
  else if ( _stricmp(str,"NO_MOTOR_DRIVE") == 0 ) { v = NX_NO_MOTOR_DRIVE; ret = true; }
  else if ( _stricmp(str,"FIXED_JOINT") == 0 ) { v = NX_FIXED_JOINT; ret = true; }
  //endbach
  return ret;
}
...
void NxJointDesc::copyTo(::NxJointDesc &desc,CustomCopy &cc)
{
  ...
  desc.userData=(void*)(mUserProperties);
  //end-bach
}

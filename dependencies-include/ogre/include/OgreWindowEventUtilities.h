	...
	*/
	...
	public:
		...
		*/
		...
		/**
		@Remarks
		Window has received mousewheel notification
		(usefull for laptop touchpads)
		not official, added by bach
		@param rw
		The RenderWindow which created this events
		@param wParam
		wParam from WM_MOUSEWHEEL message
		*/
		virtual void windowMouseWheel(RenderWindow* rw, WPARAM wParam) {}
	};
